...
class ProfilePage extends React.Component<Props & RouteComponentProps<any>, State> {
  ...
  componentDidMount() {
      let profileUrl = "/profiles/"+ this.props.match.params.authorname;
      let articlesByProfileUrl = "/articles/?author="+ this.props.match.params.authorname;
      let favoritedArticlesUrl = "/articles/?favorited="+ this.props.match.params.authorname;
  ...
  followUser = (e: any) => {
    let profileUrl = "/profiles/"+ this.props.match.params.authorname +'/follow';
    let method;
